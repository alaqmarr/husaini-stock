...
export default function PaymentsClient({ payments, pendingPayments, customers }: { payments: any[], pendingPayments: any[], customers: any[] }) {
  ...
  const displayedPayments = viewFilter === 'PENDING' ? pendingPayments : payments;
